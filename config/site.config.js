...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'zkg@moeact.com',
  ...
  protectedRoutes: ['/MoeACG/2019.2.19 B站律师函', '/学习-Study/Class', '/Files/喵喵'],
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Zhaokugua/onedrive-vercel-index',
    },
    {
      name: 'Telegram',
